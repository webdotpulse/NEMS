...
- **Supported Device Integrations**: Modbus TCP and REST API support for various manufacturers, including Huawei, Raedian, Solis, SMA, Easee, Enerlution, HomeWizard, Peblar, and P1 meters.
